...
--     more than three times that of any of their neighbours (in the same continent). 
...
-- ----------------------------
--  https://napier.sqlzoo.net/wiki/Nested_SELECT_Quiz
-- ----------------------------

--1. Select the code that shows the name, region 
--    and population of the smallest country in each region.
...
--2. Select the code that shows the countries belonging to regions 
...
--3. Select the code that shows the countries with a less than a third of the population 
--    of the countries around it.
SELECT name, region 
FROM bbc x
...
--5. Select the code that would show the countries with a greater GDP 
...
--6. Select the code that shows the countries with population smaller than Russia 
--    but bigger than Denmark.
SELECT name 
FROM bbc
WHERE population < (SELECT population 
                    FROM bbc 
